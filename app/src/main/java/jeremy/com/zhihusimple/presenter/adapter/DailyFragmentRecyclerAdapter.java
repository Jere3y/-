...
import jeremy.com.zhihusimple.model.bean.daily.Daily;
import jeremy.com.zhihusimple.model.bean.daily.HeadLine;
import jeremy.com.zhihusimple.model.bean.daily.Response;
import jeremy.com.zhihusimple.model.bean.zhihu.TopStories;
import jeremy.com.zhihusimple.utils.ScreenUtil;
import jeremy.com.zhihusimple.view.activity.DailyFeedActivity;
import jeremy.com.zhihusimple.view.activity.GankWebActivity;
import jeremy.com.zhihusimple.view.widget.TopStoriesViewPager;

public class DailyFragmentRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DailyFragmentRecyclerAdapter(Context context, Response response) {
