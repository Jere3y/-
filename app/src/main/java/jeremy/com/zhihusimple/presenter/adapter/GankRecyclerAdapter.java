...
import jeremy.com.zhihusimple.view.activity.GankActivity;
import jeremy.com.zhihusimple.view.activity.PictureActivity;
...
public class GankRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GankRecyclerAdapter(Context mContext, List<Gank> mList) {
