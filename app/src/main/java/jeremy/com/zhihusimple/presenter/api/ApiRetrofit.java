...
import jeremy.com.zhihusimple.MyApp;
import jeremy.com.zhihusimple.utils.StateUtils;
...
public class ApiRetrofit {
    ...
    ApiRetrofit() {
        ...
        GankApiService = retrofitGank.create(GankApi.class);
        DailyApiService = retrofitDaily.create(DailyApi.class);
    }
